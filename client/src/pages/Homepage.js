        ...
        <div className="container text-center">
          <div className="row">
            <div className="col-md-4 mb-4">
              ...
              <p>Effortlessly monitor your expenses and stay on top of your budget.</p>
            </div>
            <div className="col-md-4 mb-4">
              {}
              <h3>Bill Notifications</h3>
              <p>Receive alerts for recurring bill payments to avoid missing deadlines.</p>
            </div>
            <div className="col-md-4 mb-4">
              {}
              <h3>Data Visualization</h3>
              <p>Visualize your financial progress with intuitive graphs and charts.</p>
            </div>
          </div>
        </div>
      </section>
